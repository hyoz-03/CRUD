      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<form method="post" action="delete02.php">
				
			<form class="needs-validation" novalidate>
            <div class="row">
              <div class="col-md-4 mb-4">
                <label for="cpf"><h4>CPF do usuário a ter o cadastro excluído</h4></label>
				...
				<button class="btn btn-primary btn-lg btn-block" type="submit">Excluir</button>
				</div>
			</form>
