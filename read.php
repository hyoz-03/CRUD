      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<h4><table border="1">
				<tr>
					<td>Nome</td><td>RG</td><td>CPF</td><td>Endereço    </td><td>Bairro</td><td>Cidade</td><td>Uf</td><td>Cep</td><td>Telefone</td><td>Celular</td><td>Email</td><td>Como ficou sabendo    </td>
				</tr>
				<?php
