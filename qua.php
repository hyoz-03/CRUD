          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Aterro zero na industria</a>
                  </h4>
                  <p class="card-text">A palestra abordará a produção mais limpa na indústria, falando...</p>
                  </h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Caminhos para tecnologias limpas</a>
                  </h4>
                  <p class="card-text">Avaliação da efetividade de políticas gorvenamentais direcionadas à...</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Nessa palestra será discutido o Inquilinismo, uma relação ecológica em que uma espécie extrai vantagens de...</p>
                </div>
              </div>
            </div>
