...
$query = ("UPDATE cliente SET nome='$nome', rg='$rg', cpf='$cpf', end='$end', bairro='$bairro', cidade='$cidade', uf='$uf', cep='$cep', tel='$tel', cel='$cel', email='$email', opc='$opc' WHERE cpf='$cpfb' ");
$resposta = mysqli_query($con, $query);

if (!$resposta){
	echo "Erro: Não foi possível atualizar o cadastro." . PHP_EOL;
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<h4>Cadastro atualizado</h4><br><br>
          </div>
          <!-- /.row -->
