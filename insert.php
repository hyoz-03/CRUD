...
$query = "INSERT INTO cliente VALUES ('$nome', '$rg', '$cpf', '$end', '$bairro', '$cidade', '$uf', '$cep', '$tel', '$cel', '$email', '$opc')";
$resposta = mysqli_query($con, $query);

if (!$resposta){
	echo "Erro: Não foi possível realizar o cadastro." . PHP_EOL;
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
			...
			<h4>Usuário Cadastrado</h4><br><br>
          </div>
