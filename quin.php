          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Ferramentas de controle à poluição</a>
                  </h4>
                  <p class="card-text">Serão apresentadas as modernização nos sistemas de Promon Ar, Procon água e o Manifesto de resíduos...</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Gestão de resídos urbanos</a>
                  </h4>
                  <p class="card-text">A palestra sobre Gestão de Resídos Sólidos Urbanos tem como foco orientar prefeituras em como...</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Uma reflexão sobre a importância de desenvolvimento de líderes...</p>
                </div>
              </div>
            </div>
