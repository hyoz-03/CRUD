          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Vantagens competitivas da sustentabilidade</a>
                  </h4>
                  <p class="card-text">Aumentar a competitividade das empresas por meio de...</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>Borboletas em Osasco</a>
                  </h4>
                  <p class="card-text">A palestra sobre borboletas tem como objetivo difundir conhecimento sobre insetos...</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a>A hora e a vez da energia solar</a>
                  </h4>
                  <p class="card-text">Sobre energia solar no Brasil, no resto do mundo e como podemos explo...</p>
                </div>
              </div>
            </div>
